...
@Component({
  selector: 'app-register-blogguer',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterLink, GoogleSigninButtonModule],
  templateUrl: './register-blogguer.component.html',
  styleUrl: './register-blogguer.component.css',
})
export class RegisterBlogguerComponent implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    ...
    const registerRequest: RegisterRequest = {
      ...
      role: 'BLOGGER' // Forcer le rôle BLOGGER
    };
  ...
  private handleGoogleSignIn(user: SocialUser): void {
    ...
    // Envoyer le token au backend avec le rôle BLOGGER
    this.authService.googleLogin(user.idToken, 'BLOGGER').subscribe({
      next: (response) => {
